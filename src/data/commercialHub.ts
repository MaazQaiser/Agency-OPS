...
export const activeSubmissions: HubSubmission[] = [
  {
    ...
    carrierSubmissions: [
      { carrier: "Markel", status: "Quoted", premium: "$8,700" },
      { carrier: "Kingsway", status: "Declined" },
      { carrier: "Travelers", status: "Pending" },
    ],
    quoteComparison: [{ carrier: "Markel", premium: "$8,700", notes: "Best terms — awaiting client review" }],
    missingDocs: [],
