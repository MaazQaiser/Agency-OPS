...
const producerProfiles: UserProfile[] = [
  ...
  },
  {
    ...
    department: "Commercial Production",
    shiftStatus: "On shift",
    currentQueue: "Renewals",
    status: "online",
    kpis: [
      { id: "k1", label: "Quotes reviewed", value: 4, route: `${routes.commercialHub}?view=quote-review` },
      { id: "k2", label: "Draft approvals", value: 1, route: `${routes.sendCenter}?view=pending-review` },
      { id: "k3", label: "Sent proposals", value: 6, route: `${routes.sendCenter}?view=sent` },
      { id: "k4", label: "Bound policies", value: 2, route: `${routes.commercialHub}?view=ready-to-bind` },
    ],
    workload: [
      { id: "w1", label: "Active tasks", detail: "Seoul Restaurant renewal", route: `${routes.commercialHub}?view=submissions` },
      ...
      { id: "w4", label: "Follow-ups due", detail: "1 renewal reminder", route: `${routes.commercialHub}?view=follow-ups` },
      { id: "w5", label: "Overdue items", detail: "0 overdue", route: routes.commercialHub },
    ],
    recentActivity: [
    ...
    managerNotes: "Renewal focus this month — restaurant program accounts.",
  },
];
