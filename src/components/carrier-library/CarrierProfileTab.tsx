...
import { ProfileSkeleton } from "@/components/shared/loading";
...
export function CarrierProfileTab() {
  ...
  const {
    ...
    load: () => getCarrierProfile(carrierId),
    deps: [carrierId],
    ...
    return (
      <DataStateView
        ...
        empty={
          <HubEmptyState
            preset="generic-list"
            title="Carrier profile not found"
            description="The requested carrier profile could not be loaded."
